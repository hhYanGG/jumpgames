...
void PhysicsSprite::initBody(float x, float y, float width, float height)
{
	...
	b2PolygonShape shape;	//ÅäÖÃÅö×²Çø
...
void PhysicsSprite::BeginContact(PhysicsSprite* other, b2Contact* contact)
{
}

void PhysicsSprite::EndContact(PhysicsSprite* other, b2Contact* contact)
{
}

void PhysicsSprite::PreSolve(PhysicsSprite* other, b2Contact* contact, const b2Manifold* oldManifold)
{
}

void PhysicsSprite::PostSolve(PhysicsSprite* other, b2Contact* contact, const b2ContactImpulse* impulse)
{
}